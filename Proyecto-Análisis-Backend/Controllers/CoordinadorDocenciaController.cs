...
namespace Proyecto_Análisis_Backend.Controllers
{
    ...
    [ApiController]
    public class CoordinadorDocenciaController : ControllerBase
    {
        private readonly PHAtlanticoContext _context;

        public CoordinadorDocenciaController(IConfiguration configuration)
        {
        ...
        public async Task<ActionResult> Authenticate(string usuario, string contraseña)
        {
            ...
            var usuarioRevisado = await _context.CoordinadorDocencia.AnyAsync(c => c.Usuario == usuario);
            ...
            var coincidencia = await _context.CoordinadorDocencia
