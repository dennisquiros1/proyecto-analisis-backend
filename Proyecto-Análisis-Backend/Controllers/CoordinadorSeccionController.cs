...
namespace Proyecto_Análisis_Backend.Controllers
{
    ...
    [ApiController]
    public class CoordinadorSeccionController : ControllerBase
    {
        private readonly PHAtlanticoContext _context;

        public CoordinadorSeccionController(IConfiguration configuration)
        {
        ...
        public async Task<ActionResult> Authenticate(string usuario, string contraseña)
        {
            ...
            var usuarioRevisado = await _context.CoordinadorSeccions.AnyAsync(c => c.Usuario == usuario);
            ...
            var coincidencia = await _context.CoordinadorSeccions
